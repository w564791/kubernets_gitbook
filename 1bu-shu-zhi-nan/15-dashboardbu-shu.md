...
```
[root@ip-10-10-6-201 k8s]# cat kubernetes-dashboard.yaml 
  ...
  template:
    ...
    spec:
      ...
      - name: kubernetes-dashboard-init
        image: index.tenxcloud.com/jimmy/kubernetes-dashboard-init-amd64:v1.0.1
        volumeMounts:
        - name: kubernetes-dashboard-certs
          mountPath: /certs
      containers:
      - name: kubernetes-dashboard
        image: index.tenxcloud.com/jimmy/kubernetes-dashboard-amd64:v1.7.1
        ports:
        - containerPort: 8443
          protocol: TCP
        args:
...
```
[root@ip-10-10-6-201 k8s]# cat cluster-pxsj-admin.yaml
